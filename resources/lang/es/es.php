...
return[
    ...
    'Lao Peoples Democratic Republic' => 'Laos, República Democrática Popular de',
    ...
    'Nevermind, I will keep my old plan' => 'No importa, mantendré mi antiguo plan',
    'New' => 'Nuevo',
    ...
    'Please copy your new API token. For your security, it wont be shown again.' => 'Por favor copie su nuevo token API. Por su seguridad, no se volverá a mostrar.',
    ...
    'Thanks for your continued support. Weve attached a copy of your invoice for your records. Please let us know if you have any questions or concerns.' => 'Gracias por su apoyo continuo. Hemos adjuntado una copia de su factura para sus registros. Háganos saber si tiene alguna pregunta o inquietud.',
    'Thanks,' => 'Gracias,',
    ...
    'The government wont let us show you whats behind these doors' => 'El gobierno no nos permitirá mostrarle lo que hay detrás de estas puertas',
    ...
    'The teams name and owner information.' => 'Nombre del equipo e información del propietario.',
    ...
    'Two factor authentication is now enabled. Scan the following QR code using your phones authenticator application.' => 'La autenticación de dos factores ahora está habilitada. Escanee el siguiente código QR usando la aplicación de autenticación de su teléfono.',
    'Uganda' => 'Uganda',
    'Ukraine' => 'Ucrania',
    ...
    'Update your accounts profile information and email address.' => 'Actualice la información de su cuenta y la dirección de correo electrónico',
    'Uruguay' => 'Uruguay',
    ...
    'Were lost in space. The page you were trying to view does not exist.' => 'Estamos perdidos en el espacio. La página que intenta buscar no existe.',
    'Welcome Back!' => '¡Bienvenido de nuevo!',
    'Western Sahara' => 'Sahara Occidental',
    'When two factor authentication is enabled, you will be prompted for a secure, random token during authentication. You may retrieve this token from your phones Google Authenticator application.' => 'Cuando la autenticación de dos factores esté habilitada, le pediremos un token aleatorio seguro durante la autenticación. Puede recuperar este token desde la aplicación Google Authenticator de su teléfono.',
    'Whoops' => 'Ups',
    'Whoops!' => '¡Ups!',
